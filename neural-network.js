...
class NeuralNetwork {
	...
	this.outputs = Matrix.add(outputs, this.bias1);
	...
	train(inputArray, targetArray) {
		...
		// calculate the deltas (errors * derivatives of the output)
		...
		//calculate the hidden deltas (errors * derivitives of hidden)
...
class Matrix {
	constructor(rows, cols, data = []) {
		...
		//initilaize with zeroes if no data provided
